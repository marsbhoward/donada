...
(function (): Contract {
    ...
    const depositNFT = Deposit(
      ...
      nftToken, 1 // NFT token with quantity 1
    );
    ...
    const distributeWinningsRented = When(
        ...
        Constant(drawDate + 60 * 60 * 24), // Timeout set to 1 day after the draw date
        Close // Timeout continuation: if the timeout is reached, the contract will close
      );
